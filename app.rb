...
module BlogPoole
  class App < Sinatra::Base
    ...
    def site_params
      ...
      safe_params["baseurl"] = '/'+safe_params['baseurl'] unless safe_params['baseurl'].match(/^\//) or params['site']['path'].blank?
    ...
    def commit_new_jekyll(dir, user_options)
      ...
      @api.edit_repository(full_repo_path, {
          description: 'A Jekyll-powered site generated by jekyll:pizza:pizza',
    ...
    def repository_url(safe_params)
      ...
      blog_path(safe_params['baseurl']).gsub("https://","").gsub("/","")
    end
